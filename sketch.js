...
function setup() {
  ...
  ground= createSprite(200,400,100000,20);
  ground.addImage(groundImage)
  ground.scale=0.1;
  ground.velocityX=10;
  
  invisibleGround= createSprite(200,400,100000,30);
  invisibleGround.visible=false;
  ground.setCollider("rectangle",200,0,20000,400);
  babu= createSprite(530,400,20,20)
...
function banana(){
 if(frameCount%109==0){
  bananas= createSprite(0,random(20,170),20,20)
...
function rock(){
  if(frameCount%110===0){
    obstacles=createSprite(0,350,20,20)
